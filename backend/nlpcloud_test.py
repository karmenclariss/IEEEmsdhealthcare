...
def file_to_string(file):
    ...
    with open(file,'rb') as pdf_file:
        ...
        for page_num in range(len(pdf_reader.pages)):
            ...
            content += (page_obj.extract_text(0))[0:1000]
        print(content)
        return content
        
text= file_to_string("/Users/karmen/Desktop/IEEEmsdhealthcare-/testpdf3.pdf")
...
def sentimentResponse(api_key,text):
    client = nlpcloud.Client("distilbert-base-uncased-finetuned-sst-2-english", api_key, gpu=True, lang="en")
...
def infographicCreation(text, summary):
    api_key = "b63ca4df943496fe98ef208580041f78a3667554"
    keywords = keywordsResponse(api_key, text)
    ...
    infographic.paste(Image.fromarray(wordcloudnp.astype('uint8')), (150, 150))

    # Add a text box to the infographic and write the summary text inside it
    draw = ImageDraw.Draw(infographic)
    text_font1 = ImageFont.truetype("/Users/karmen/Desktop/IEEEmsdhealthcare-/arial.ttf", size=36)
    text_font2 = ImageFont.truetype("/Users/karmen/Desktop/IEEEmsdhealthcare-/arial.ttf", size=24)

    # Define text boxes
    text_boxes = [ ((370, 50, 50, 50), "Generated Report", text_font1),
                  ((370, 120, 400, 100), "Keywords from article:", text_font2),
                ((370, 500, 1150, 750), "Summarised Article:", text_font2)]
...
if __name__ == '__main__':
    ...
    infographicCreation(text=text,summary=summary)